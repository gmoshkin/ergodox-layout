...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYMBOLS] = LAYOUT_ergodox(
    ...
    _______ , KC_UP   , KC_KP_7 , KC_KP_8, KC_KP_9, KC_ASTR , KC_F12  ,
              KC_DOWN , KC_KP_4 , KC_KP_5, KC_KP_6, KC_PLUS , KC_LGUI ,
    _______ , KC_AMPR , KC_KP_1 , KC_KP_2, KC_KP_3, KC_BSLS , _______ ,
                        TG(SWP) , KC_DOT , KC_KP_0, KC_EQL  , _______ ,
  ...
  [SWAP] = LAYOUT_ergodox(
    ...
    KC_RSFT     , KC_N      , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , MO(SYM) ,
    ...
    MO(SYM) , KC_Z , KC_X    , KC_C    , KC_V   , KC_B    , KC_LSFT     ,
